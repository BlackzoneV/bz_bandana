...
--if PlayerData.job and PlayerData.job.name == 'grove' or PlayerData.job.name == 'ballas' or PlayerData.job.name == 'vagos' or PlayerData.job.name == 'bloodz' or PlayerData.job.name == 'aztecas' then
local oluPlayer, oluDistance = ESX.Game.GetClosestPlayer()
if IsPedDeadOrDying(GetPlayerPed(oluPlayer)) then
